...
import 'package:eatsafeproject/reviews/searches.dart';
...
class searchReviews extends StatefulWidget {
  const searchReviews({Key? key}) : super(key: key);

  @override
  State<searchReviews> createState() => _searchReviewsState();
}
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'Select the restautant you want to read reviews about.',
                                          style: TextStyle(
                                  ...
                                  child: TextButton(
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => searches(queries: savename,)),
                                      );
                                    },
                                    child: Text(
                                      "      Search      ",
